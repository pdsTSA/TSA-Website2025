    ...
    return <>
        ...
        <div className={style.terms}>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Website</strong> refers to Adobo Agogo, accessible from <a
                        href="https://adobo-agogo.vercel.app/" rel="external nofollow noopener"
                        target="_blank">https://adobo-agogo.vercel.app/</a></p>
                </li>
                <li>
            ...
            <ul>
                <li>By email: adoboagogo@gmail.com</li>
            </ul>
        </div>
    </>
}
